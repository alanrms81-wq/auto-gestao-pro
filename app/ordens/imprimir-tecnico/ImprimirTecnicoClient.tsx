...
export default function ImprimirTecnicoClient({ id }: { id: string }) {
    ...
    <div className="page">
      ...
      <div className="sheet print-container">
                ...
                servicos.map((s, idx) => (
                  <tr key={s.id || String(idx)}>
                    ...
                    <td>
                      {moneyBR(
                        toMoney(s.subtotal) ||
                          toMoney(s.quantidade) * toMoney(s.valor_unitario)
                      )}
                    </td>
                    <td>_____</td>
                  </tr>
        ...
        <section className="block compact-block no-break">
          ...
          <div className="grid three compact-grid">
            <div className="cardinfo">
              ...
              <p>{moneyBR(subtotalProdutos)}</p>
            </div>
            <div className="cardinfo">
              <strong>SERVIÇOS</strong>
              <p>{moneyBR(subtotalServicos)}</p>
            </div>
            <div className="cardinfo">
              <strong>TOTAL OS</strong>
              <p>{moneyBR(toMoney(ordem.total) || subtotalProdutos + subtotalServicos)}</p>
            </div>
          </div>
        </section>
        ...
        <section className="signatures no-break">
          ...
          <div className="signbox">
            <span>CONFERÊNCIA / RESPONSÁVEL</span>
          </div>
        </section>
      </div>
      ...
      <style jsx>{`
        ...
        .bigspace { height: 120px; border: 1px dashed #d1d5db; border-radius: 10px; }
